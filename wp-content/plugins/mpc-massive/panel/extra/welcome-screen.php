...
class MPC_Setup_Wizard {
	...
	public function setup_wizard_header() {
		...
		<body class="ma-setup ma-step-<?php echo $this->step ?> <?php echo $this->step == 'download' ? 'ma-step-presets' : '' ?> wp-core-ui">
	...
	public function setup_wizard_footer() {
		...
		<?php endif; ?>
		<?php if ( isset( $_GET[ 'step' ] ) && in_array( sanitize_key( $_GET[ 'step' ] ), array( 'presets', 'download' ) ) ) {
