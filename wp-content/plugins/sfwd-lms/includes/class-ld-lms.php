	...
	class SFWD_LMS extends Semper_Fi_Module  {
		...
		function add_post_types() {
			...
			$lesson_topic_labels = array(
				...
				'add_new_item' => sprintf( __( 'Add New %s', 'learndash' ), $lcl_topic ),
				'edit_item' => sprintf( __( 'Edit %s', 'learndash' ), $lcl_topic ),
				'new_item' => sprintf( __( 'New %s', 'learndash' ), $lcl_topic ),
				'all_items' => $lcl_topics,
				'view_item' => sprintf( __( 'View %s', 'learndash' ), $lcl_topic ),
				'search_items' => sprintf( __( 'Search %s', 'learndash' ), $lcl_topics ),
				'not_found' => sprintf( __( 'No %s found', 'learndash' ), $lcl_topics ),
				'not_found_in_trash' => sprintf( __( 'No %s found in Trash', 'learndash' ), $lcl_topics ),
				'parent_item_colon' => '',
			...
			$quiz_labels = array(
				...
				'add_new' => __( 'Add New', 'learndash' ),
				'add_new_item' => sprintf( __( 'Add New %s', 'learndash' ), $lcl_quiz ),
				'edit_item' => sprintf( __( 'Edit %s', 'learndash' ), $lcl_quiz ),
				'new_item' => sprintf( __( 'New %s', 'learndash' ), $lcl_quiz ),
				'all_items' => $lcl_quizzes,
				'view_item' => sprintf( __( 'View %s', 'learndash' ), $lcl_quiz ),
				'search_items' => sprintf( __( 'Search %s', 'learndash' ), $lcl_quizzes ),
				'not_found' => sprintf( __( 'No %s found', 'learndash' ), $lcl_quizzes ),
				'not_found_in_trash' => sprintf( __( 'No %s found in Trash', 'learndash' ), $lcl_quizzes ),
				'parent_item_colon' => '',
			);
			...
			$lesson_labels = array(
				...
				'add_new' => __( 'Add New', 'learndash' ),
				'add_new_item' => sprintf( __( 'Add New %s', 'learndash' ), $lcl_lesson ),
				'edit_item' => sprintf( __( 'Edit %s', 'learndash' ), $lcl_lesson ),
				'new_item' => sprintf( __( 'New %s', 'learndash' ), $lcl_lesson ),
				'all_items' => $lcl_lessons,
				'view_item' => sprintf( __( 'View %s', 'learndash' ), $lcl_lesson ),
				'search_items' => sprintf( __( 'Search %s', 'learndash' ), $lcl_lessons ),
				'not_found' => sprintf( __( 'No %s found', 'learndash' ), $lcl_lessons ),
				'not_found_in_trash' => sprintf( __( 'No %s found in Trash', 'learndash' ), $lcl_lessons ),
				'parent_item_colon' => '',
			);
			...
			$course_labels = array(
				...
				'add_new' => __( 'Add New', 'learndash' ),
				'add_new_item' => sprintf( __( 'Add New %s', 'learndash' ), $lcl_course ),
				'edit_item' => sprintf( __( 'Edit %s', 'learndash' ), $lcl_course ),
				'new_item' => sprintf( __( 'New %s', 'learndash' ), $lcl_course ),
				'all_items' => $lcl_courses,
				'view_item' => sprintf( __( 'View %s', 'learndash' ), $lcl_course ),
				'search_items' => sprintf( __( 'Search %s', 'learndash' ), $lcl_courses ),
				'not_found' => sprintf( __( 'No %s found', 'learndash' ), $lcl_courses ),
				'not_found_in_trash' => sprintf( __( 'No %s found in Trash', 'learndash' ), $lcl_courses ),
				'parent_item_colon' => '',
			);
			...
			$post_args = array(
				array(
					...
					'fields' => array( 
						'course_materials' => array(
							'name' => sprintf( __( '%s Materials', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
							'type' => 'textarea',
							'help_text' => __( 'Options for course materials', 'learndash' ),
						),
						'course_price_type' => array(
							'name' => sprintf( __( '%s Price Type', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
							'type' => 'select',
						...
						'course_price' => array(
							'name' => sprintf( __( '%s Price', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
							'type' => 'text',
						...
						'course_access_list' => array(
							'name' => sprintf( __( '%s Access List', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
							'type' => 'textarea',
						...
						'course_lesson_orderby' => array(
							'name' => sprintf( __( 'Sort %s By', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ),
							'type' => 'select',
							'initial_options' => array(	
						...
						'course_lesson_order' => array(
							'name' => sprintf( __( 'Sort %s Direction', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ),
							'type' => 'select',
							'initial_options' => array(	
								''		=> __( 'Use Default', 'learndash' ),
						...
						'course_prerequisite' => array( 
							'name' => sprintf( __( '%s prerequisites', 'learndash' ),LearnDash_Custom_Label::get_label( 'course' ) ), 
							'type' => 'select', 
						...
						'course_disable_lesson_progression' => array(
							'name' => sprintf( __( 'Disable Lesson Progression', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ),
							'type' => 'checkbox',
							'default' => 0,
						...
						'expire_access_delete_progress' => array(
							'name' => sprintf( __( 'Delete %s and %s Data After Expiration', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
							'type' => 'checkbox',
						...
						'course_disable_content_table' => array(
							'name' => __( 'Hide Course Content table', 'learndash' ),
							'type' => 'checkbox',
							'default' => 0,
				...
				array(
					...
					'options_page_title' => sprintf( __( '%s Options', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ),
					'fields' => array(
						'course' => array( 
							'name' => sprintf( __( 'Associated %s', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ), 
							'type' => 'select', 
						...
						'forced_lesson_time' => array( 
							'name' => sprintf( __( 'Forced %s Timer', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ), 
							'type' => 'text', 
							'help_text' => sprintf( __( 'Minimum time a user has to spend on %s page before it can be marked complete. Examples: 40 (for 40 seconds), 20s, 45sec, 2m 30s, 2min 30sec, 1h 5m 10s, 1hr 5min 10sec', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ), 
							'default' => '',
						),
						...
						'sample_lesson' => array( 
							'name' => sprintf( __( 'Sample %s', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ), 
							'type' => 'checkbox', 
				...
				array(
					...
					'options_page_title' => sprintf( __( '%s Settings', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					'fields' => array(
						'repeats' => array( 
						...
						'lesson' => array( 
							'name' => sprintf( __( 'Associated %s', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ), 
							'type' => 'select', 
						...
						'quiz_pro_html' => array(
							'name' => sprintf( __( '%s Options', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
							'type' => 'html',
							'help_text' => '',
							'label' => 'none',
							'save' => false,
				...
				array(
					'plugin_name' => sprintf( _x( '%1$s %2$s', 'Original: Lesson Topic', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ), LearnDash_Custom_Label::get_label( 'topic' ) ),
					...
					'options_page_title' => sprintf( _x( '%1$s %2$s Options', 'Original: Lesson Topic Options', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ), LearnDash_Custom_Label::get_label( 'topic' ) ),
					'fields' => array(
						'course' => array( 
							'name' => sprintf( __( 'Associated %s', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ), 
							'type' => 'select', 
						...
						'forced_lesson_time' => array( 
							'name' => sprintf( __( 'Forced %s Timer', 'learndash' ), LearnDash_Custom_Label::get_label( 'topic' ) ), 
							'type' => 'text', 
							'help_text' => sprintf( __( 'Minimum time a user has to spend on %s page before it can be marked complete. Examples: 40 (for 40 seconds), 20s, 45sec, 2m 30s, 2min 30sec, 1h 5m 10s, 1hr 5min 10sec', 'learndash' ), LearnDash_Custom_Label::get_label( 'topic' ) ), 
							'default' => '',
						),
						'lesson_assignment_upload' => array( 
							'name' => __( 'Upload Assignment', 'learndash' ), 
		...
		function show_course_info( $user ) {
			$user_id = $user->ID;
			echo '<h3>' . sprintf( __( '%s Info', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ) . '</h3>';
		...
		function courses_filter_submit( $submit ) {
			$submit['courses_export_submit'] = array( 
				...
				'value' => sprintf( __( 'Export User %s Data &raquo;', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ) 
			);
			return $submit;
		}
		...
		function quiz_filter_submit( $submit ) {			
			$submit['quiz_export_submit'] = array( 
				'type' => 'submit',
				'class' => 'button-primary',
				'value' => sprintf( __( 'Export %s Data &raquo;', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ) 
			);
			return $submit;
		}
		...
		function select_a_course( $current_post_type = null ) {
			...
			$post_array = array( '0' => sprintf( __( '-- Select a %s --', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ) );
		...
		function select_a_lesson_or_topic( $course_id = null ) {
			...
			$post_array = array( '0' => sprintf( __( '-- Select a %s or %s --', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ), LearnDash_Custom_Label::get_label( 'topic' ) ) );
			if ( ! empty( $posts ) ) {
				foreach ( $posts as $p ){
					$post_array[ $p->ID ] = $p->post_title;
		...
		function select_a_lesson( $course_id = null ) {			
			...
			$posts = get_posts( $opt );
			$post_array = array( '0' => sprintf( __( '-- Select a %s --', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ) );
