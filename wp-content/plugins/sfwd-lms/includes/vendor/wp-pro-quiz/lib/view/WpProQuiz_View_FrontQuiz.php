...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View {
	...
	public function script($preview = false) {
		...
		if (!isset($quiz_meta['sfwd-quiz_passingpercentage'])) {
			$quiz_meta_sfwd_quiz_passingpercentage = '0';
		} else {
			$quiz_meta_sfwd_quiz_passingpercentage = $quiz_meta['sfwd-quiz_passingpercentage'];
		}
...
<?php 
	...
	?>
		<div style="display: none;" class="wpProQuiz_loadQuiz">
			<p>
				<?php printf( __('%s is loading...', 'learndash'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>
			</p>
		</div>
	<?php 
	}
