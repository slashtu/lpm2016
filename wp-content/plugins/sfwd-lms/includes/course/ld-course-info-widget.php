...
class LearnDash_Course_Info_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'ldcourseinfo', sprintf( __( 'Course Information', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ), $widget_ops, $control_ops );
	}
...
class LearnDash_Course_Navigation_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			...
			'description' => sprintf( __( 'LearnDash - %s Navigation. Shows lessons and topics on the current course.', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) )
		);
		$control_ops = array(); //'width' => 400, 'height' => 350);
		parent::__construct( 'widget_ldcoursenavigation', sprintf( __( '%s Navigation', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ), $widget_ops, $control_ops );
	}
