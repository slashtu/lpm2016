...
class LearnDash_Custom_Label {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'sfwd-module-style', LEARNDASH_LMS_PLUGIN_URL . '/assets/css/sfwd_module.css', array(), LEARNDASH_VERSION );

		wp_enqueue_script( 'sfwd-module-script', LEARNDASH_LMS_PLUGIN_URL . '/assets/js/sfwd_module.js', array( 'jquery' ), LEARNDASH_VERSION );
