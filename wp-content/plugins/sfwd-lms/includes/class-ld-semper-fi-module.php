...
if ( ! class_exists( 'Semper_Fi_Module' ) ) {
	...
	function enqueue_styles() {
		...
		wp_enqueue_style( 'sfwd-module-style', $this->plugin_path['url'] . 'assets/css/sfwd_module.css', array(), LEARNDASH_VERSION );
	}
	...
	function enqueue_scripts() {
		...
		$this->script_data['select_a_lesson_lang']          = sprintf( __( '-- Select a %s --', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) );
		$this->script_data['select_a_lesson_or_topic_lang'] = sprintf( __( '-- Select a %s or %s --', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ), LearnDash_Custom_Label::get_label( 'topic' ) );
