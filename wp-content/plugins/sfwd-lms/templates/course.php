...
<?php if ( $logged_in ) : ?>
	<span id="learndash_course_status">
		<b><?php printf( __( '%s Status:', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ); ?></b> <?php echo $course_status; ?>
		<br />
	</span>
	<br />
...
<?php if ( isset( $materials ) ) : ?>
	<div id="learndash_course_materials">
		<h4><?php printf( __( '%s Materials', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ); ?></h4>
...
<?php if ( $has_course_content ) : ?>
	<?php 
		...
		if ( $show_course_content ) :
			...
			<h4 id="learndash_course_content_title"><?php printf( __( '%s Content', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ); ?></h4>
