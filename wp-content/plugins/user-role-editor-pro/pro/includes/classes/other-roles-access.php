...
<?php        
    ...
    public function update_data() {
        ...
        if ($ure_object_type!=='role' && $ure_object_type!=='user') {
            $this->lib->notification = esc_html__('URE: other roles access: Wrong object type. Data was not updated.', 'user-role-editor');
            return;
        }
        $ure_object_name = filter_input(INPUT_POST, 'ure_object_name', FILTER_SANITIZE_STRING);
        if (empty($ure_object_name)) {
            $this->lib->notification = esc_html__('URE: other roles access: Empty object name. Data was not updated', 'user-role-editor');
            return;
        }
        ...
        $this->lib->notification = esc_html__('Other roles access data was updated successfully', 'user-role-editor');
